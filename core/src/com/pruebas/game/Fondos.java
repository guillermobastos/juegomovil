...
//        font.getData().setScale(4);
    ...
    public void dibujarFondoCreditos() {
        ...
        font.draw(spriteBatch, String.format(miJuego.myBundle.get("musica")), anchoPantalla / 3 - espacio_entre_botones / 2, altoPantalla - espacio_entre_botones*2);
        ...
        font.draw(spriteBatch, String.format(miJuego.myBundle.get("musica")), anchoPantalla / 2 + espacio_entre_botones / 2, altoPantalla - espacio_entre_botones*2);
        for (int i = 0; i < GameConstants.CREDITOS_NOMBRES_MUSICA.length; i++) {
            font.draw(spriteBatch, String.format("%s", GameConstants.CREDITOS_NOMBRES_MUSICA[i]), anchoPantalla / 2 + espacio_entre_botones / 2, altoPantalla - espacio_entre_botones - ((i + 2) * espacio_entre_botones * 2 / 3));
        }
        dibujarBotonVolver();
